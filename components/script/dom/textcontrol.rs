...
impl<'a, E: TextControlElement> TextControlSelection<'a, E> {
    ...
    pub fn set_dom_range_text(
...

        {
            ...
            textinput.replace_selection(info_flow_block_dynamic_all!(sec_lat::Label_Empty, int_lat::Label_All, new_dynamic_secret_label(vec![]), new_dynamic_integrity_label(vec![]), {
